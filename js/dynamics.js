    ...
    switch(key) {
        case 0: // List link selected
            link.addEventListener('click', (e) =>{
                e.preventDefault();
                let selectedSection = document.querySelector('#main-section');
                contentSections.forEach(section => {
                    section.classList.remove('content-show')
                    section.classList.add('content-hide')
                })
        ...
        case 1: // List link selected
            link.addEventListener('click', (e) =>{
                e.preventDefault();
                let selectedSection = document.querySelector('#new-book-section');
                contentSections.forEach(section => {
                    section.classList.remove('content-show')
                    section.classList.add('content-hide')
                })
        ...
        case 2: // List link selected
            link.addEventListener('click', (e) =>{
                e.preventDefault();
                let selectedSection = document.querySelector('#contact-section');
                contentSections.forEach(section => {
                    section.classList.remove('content-show')
                    section.classList.add('content-hide')
                })
